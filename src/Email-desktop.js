import './Email-desktop-style.css'
// import Ettaimg from './images/Kuelap_Ayuk-Etta-Image.svg'
// import Arrow from './images/Kuelap_arrow.svg'
// import insta from './images/Instagram.svg'
// import tweet from './images/Twitter.svg'
// import faceb from './images/Facebook.svg'
// import linkd from './images/LinkedIn.svg'
// import vertlogo from './images/Kuelap_Logo_horizontal.svg'
// import vertlogo from './images/Kuelap__Vertical-logo.svg'
// import textund from './images/LinkedIn.svg'
...
const Emaildesk = () => {
    return (
        <div className="emaildesk-section">
            ...
            <table style={{}} className="tab2">
                <tr>
                    <td rowSpan="3"><img src={"https://firebasestorage.googleapis.com/v0/b/email-signature-716cb.appspot.com/o/Kuelap_arrow.svg?alt=media&token=f86ead3f-7e9e-4d24-a003-4ca367e42b1b"} alt="" style={{ width: "68.5px", marginLeft: "20px" }} /></td>
                    <td>
                        <img src={"https://firebasestorage.googleapis.com/v0/b/email-signature-716cb.appspot.com/o/Kuelap__Vertical-logo.svg?alt=media&token=c1d9b63c-d108-4e38-8f12-5db909933264"} alt="" style={{ width: "70px" }} />
                    </td>
                    <td style={{ borderLeft: "3px solid #6E90CA", paddingLeft: "10px", lineHeight:"11px" }}>
                        <span style={{ color: "#6E90CA", fontWeight: "bold", fontSize: "0.8rem" }}>Transforming<br />Digital<br />Financial<br />Services<br /></span>
                    </td>

                </tr>
                <tr>
                <td colspan="2" ><img src={"https://firebasestorage.googleapis.com/v0/b/email-signature-716cb.appspot.com/o/Kuelap_Ayuk-Etta-Image.svg?alt=media&token=d041cfe0-98a9-485f-ac18-7eeea6606529"} alt="" style={{ width: "140px" }} /></td>
                </tr>
                <tr>
                <td style={{ paddingLeft: "10px" }} colspan="2">
                        <span style={{ color: "#6E90CA", fontWeight: "bold", fontSize: "0.8rem" }}>Ayuk Etta<br />CEO Kuelab Africa<br /></span>
                        <span style={{ fontSize: "0.7rem", fontWeight: "bold", lineHeight:"1px"  }}>T:<a href="tel:+237691376601">(+237) 691 376 601</a><br />
                            W: <a href="https://wa.me/237691376601">691 376 601</a><br />
                            E: <a href="mailto:isaac.belambo@kuelab.africa">isaac.belombo@kuelap.africa</a><br />
                            <a href="https://kuelap.africa/">kuelap.africa | Yaounde, Cameroon</a><br />
                            <div style={{ display: "flex", flexDirection: "row", width: "150px", marginTop: "10px" }}>
